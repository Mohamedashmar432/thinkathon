...
exports.isChecklistComplete = isChecklistComplete;
exports.getLatestScansPerDevice = getLatestScansPerDevice;
exports.calculateUserSecureScore = calculateUserSecureScore;
exports.calculateEndpointExposureScore = calculateEndpointExposureScore;
...
function getLatestScansPerDevice(scans) {
...
function calculateUserSecureScore(scans, user) {
    try {
        ...
        latestScans.forEach(scan => {
            ...
            if (scan.patches && scan.patches.latestPatchDate) {
                ...
                if (daysSincePatches > 60)
                    score -= 20;
                else if (daysSincePatches > 30)
                    score -= 10;
            }
...
function calculateEndpointExposureScore(scan) {
    ...
    if (endpoints.length === 0)
        return 100; // Perfect score if no vulnerable endpoints
